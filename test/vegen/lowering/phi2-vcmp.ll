; RUN: %opt -passes=test-vector-codegen -disable-cond-packing %s -p storeOf:i,storeOf:i2 -p storeOf:i1,storeOf:i3 -p i,i2 -p i1,i3 -p cmp,cmp1 -S | FileCheck %s
...
; CHECK-NEXT:   [[CMP0:%.*]] = extractelement <2 x i1> [[VCMP]], i64 0
; CHECK-NEXT:   [[CMP1:%.*]] = extractelement <2 x i1> [[VCMP]], i64 1
; CHECK-NEXT:   [[NOT:%.*]] = xor i1 [[CMP0]], true
...
; CHECK-NEXT:   [[INS2:%.*]] = insertelement <2 x i1> undef, i1 [[CMP0]], i64 0
