...
; CHECK: entry:
; CHECK-NEXT:   br i1 %skip, label %[[IF_TRUE:.*]], label %[[IF_FALSE:.*]]
...
define void @foo(i1 %skip, float noundef %x, float noundef %y) #0 {
entry:
  br i1 %skip, label %done, label %entry0
entry0:
