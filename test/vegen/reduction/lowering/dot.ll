...
; RUN: %opt %s -S -passes=test-vector-codegen,adce,simplifycfg,indvars -p add.1.lcssa,add.1.1.lcssa,add.1.2.lcssa,add.1.3.lcssa/bottom-up -p storeOf:add.1.lcssa,storeOf:add.1.1.lcssa,storeOf:add.1.2.lcssa,storeOf:add.1.3.lcssa -p arrayidx11.promoted,arrayidx11.promoted.1,arrayidx11.promoted.2,arrayidx11.promoted.3 -p i15,i13,i3,i1,i7,i5,i11,i9 -p i14,i12,i2,i,i6,i4,i10,i8 -S | FileCheck %s
; ModuleID = 'dot.ll'
...
; CHECK:       [[HEADER]]:
; CHECK-DAG:    [[INDVARS_IV_2:%.*]] = phi i64 [ 0, %[[ENTRY]] ], [ [[INDVARS_IV_NEXT_1_2:%.*]], %[[HEADER]] ]
; CHECK-DAG:    [[DOTMU_VEC:%.*]] = phi <4 x i32> [ zeroinitializer, %[[ENTRY]] ], [ [[BINARY_REDUCER_VEC1:%.*]], %[[HEADER]] ]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_2]]
; CHECK-NEXT:    [[INDVARS_IV_NEXT:%.*]] = or i64 [[INDVARS_IV_2]], 1
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_NEXT]]
; CHECK-NEXT:    [[INDVARS_IV_NEXT_135:%.*]] = or i64 [[INDVARS_IV_2]], 1
; CHECK-NEXT:    [[ARRAYIDX_1_1:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_NEXT_135]]
; CHECK-NEXT:    [[ARRAYIDX_129:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_2]]
; CHECK-NEXT:    [[INDVARS_IV_NEXT_2:%.*]] = or i64 [[INDVARS_IV_2]], 1
; CHECK-NEXT:    [[ARRAYIDX_1_2:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_NEXT_2]]
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_2]]
; CHECK-NEXT:    [[INDVARS_IV_NEXT_3:%.*]] = or i64 [[INDVARS_IV_2]], 1
; CHECK-NEXT:    [[ARRAYIDX_1_3:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_NEXT_3]]
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds [4 x i16], ptr @a, i64 0, i64 [[INDVARS_IV_2]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <8 x ptr> [[TMP1]], ptr [[ARRAYIDX_1_1]], i64 2
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <8 x ptr> [[TMP2]], ptr [[ARRAYIDX_129]], i64 3
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <8 x ptr> [[TMP3]], ptr [[ARRAYIDX_1_2]], i64 4
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <8 x ptr> [[TMP4]], ptr [[ARRAYIDX_2]], i64 5
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <8 x ptr> [[TMP5]], ptr [[ARRAYIDX_1_3]], i64 6
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <8 x ptr> [[TMP6]], ptr [[ARRAYIDX_3]], i64 7
...
; CHECK-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 0, i64 [[INDVARS_IV_2]]
; CHECK-NEXT:    [[ARRAYIDX8_1:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 0, i64 [[INDVARS_IV_NEXT]]
; CHECK-NEXT:    [[ARRAYIDX8_1_1:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 1, i64 [[INDVARS_IV_NEXT_135]]
; CHECK-NEXT:    [[ARRAYIDX8_131:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 1, i64 [[INDVARS_IV_2]]
; CHECK-NEXT:    [[ARRAYIDX8_1_2:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 2, i64 [[INDVARS_IV_NEXT_2]]
; CHECK-NEXT:    [[ARRAYIDX8_2:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 2, i64 [[INDVARS_IV_2]]
; CHECK-NEXT:    [[ARRAYIDX8_1_3:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 3, i64 [[INDVARS_IV_NEXT_3]]
; CHECK-NEXT:    [[ARRAYIDX8_3:%.*]] = getelementptr inbounds [4 x [256 x i16]], ptr @b, i64 0, i64 3, i64 [[INDVARS_IV_2]]
...
; CHECK-NEXT:    [[INDVARS_IV_NEXT_1_2]] = add nuw nsw i64 [[INDVARS_IV_2]], 2
; CHECK-NEXT:    [[EXITCOND_1_NOT:%.*]] = icmp eq i64 [[INDVARS_IV_NEXT_1_2]], 256
; CHECK-NEXT:    [[BINARY_REDUCER_VEC:%.*]] = call <4 x i32> @llvm.x86.sse2.pmadd.wd(<8 x i16> [[I15_VEC]], <8 x i16> [[I14_VEC]])
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[BINARY_REDUCER_VEC1_LCSSA:%.*]] = phi <4 x i32> [ [[BINARY_REDUCER_VEC1]], %[[HEADER]] ]
; CHECK-NEXT:    [[BINARY_REDUCER_VEC2:%.*]] = add <4 x i32> [[ARRAYIDX11_PROMOTED_1_VEC]], [[BINARY_REDUCER_VEC1_LCSSA]]
