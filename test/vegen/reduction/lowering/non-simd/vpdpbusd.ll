...
; RUN: %opt %s -S -passes=test-vector-codegen,adce -p add.3,add.3.1,add.3.2,add.3.3/bottom-up -p arrayidx11.promoted,arrayidx11.promoted.1,arrayidx11.promoted.2,arrayidx11.promoted.3 -p storeOf:add.3,storeOf:add.3.1,storeOf:add.3.2,storeOf:add.3.3 -p i,i2,i4,i6 -p i1,i3,i5,i7,i9,i11,i13,i15,i17,i19,i21,i23,i25,i27,i29,i31 -S | FileCheck %s
; RUN: %opt %s -S -passes=test-vector-codegen,adce -p add.3,add.3.1,add.3.2,add.3.3/bottom-up -p arrayidx11.promoted,arrayidx11.promoted.1,arrayidx11.promoted.2,arrayidx11.promoted.3 -p storeOf:add.3,storeOf:add.3.1,storeOf:add.3.2,storeOf:add.3.3 -p i,i2,i4,i6 -p i1,i3,i5,i7,i9,i11,i13,i15,i17,i19,i21,i23,i25,i27,i29,i31 -detect-simple-reduction -S | FileCheck %s
