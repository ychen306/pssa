...
; RUN: %opt %s -S -passes=test-vector-codegen,adce -rdx-to-pack=add.3.lcssa -p i3,i4,i5,i6 | FileCheck %s
...
; CHECK:       [[HEADER]]:
; CHECK-DAG:    [[DOTMU_VEC:%.*]] = phi <4 x i32> [ zeroinitializer, %[[TMP3]] ], [ [[REC_RDX_VEC:%.*]], %[[LATCH:.*]] ]
