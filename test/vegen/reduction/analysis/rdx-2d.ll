...
; CHECK: Reduction for   %add.epil.lcssa = phi i32 [ %add.epil, %for.body4.epil ] is (add i4:for.body4.epil i6:for.body4.1,for.cond1.preheader@(((cmp217) /\ cmp20) /\ not i1) i7:for.body4,for.cond1.preheader@(((cmp217) /\ cmp20) /\ not i1) (i32 0)@(cmp20))
