...
; CHECK: Reduction for %add.epil.lcssa = phi i32 [ %add.epil, %for.body4.epil ] is (add i7:for.body4,for.cond1.preheader i6:for.body4.1,for.cond1.preheader i4:for.body4.epil)
; CHECK-NOT: Reduction for %add.epil
