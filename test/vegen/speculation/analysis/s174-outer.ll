...
; CHECK-DAG: IF (arrayidx6)[:4] DISJOINT WITH (arrayidx15.2)[:4]
; CHECK-DAG: IF (arrayidx15)[:4] DISJOINT WITH (arrayidx6.2)[:4]
; CHECK-DAG: IF (arrayidx6.1)[:4] DISJOINT WITH (arrayidx15.2)[:4]
; CHECK-DAG: IF (arrayidx15.1)[:4] DISJOINT WITH (arrayidx6.2)[:4]
; CHECK-DAG: IF (arrayidx6)[:4] DISJOINT WITH (arrayidx15.3)[:4]
; CHECK-DAG: IF (arrayidx15)[:4] DISJOINT WITH (arrayidx6.3)[:4]
; CHECK-DAG: IF (arrayidx6.1)[:4] DISJOINT WITH (arrayidx15.3)[:4]
; CHECK-DAG: IF (arrayidx15.1)[:4] DISJOINT WITH (arrayidx6.3)[:4]
; CHECK-DAG: IF (arrayidx6.2)[:4] DISJOINT WITH (arrayidx15.3)[:4]
; CHECK-DAG: IF (arrayidx15.2)[:4] DISJOINT WITH (arrayidx6.3)[:4]
; CHECK-DAG: IF (arrayidx6)[:4] DISJOINT WITH (arrayidx15.1)[:4]
; CHECK-DAG: IF (arrayidx15)[:4] DISJOINT WITH (arrayidx6.1)[:4]
