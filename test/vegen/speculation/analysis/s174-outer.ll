...
; CHECK-DAG:	IF ({@a,+,1280000}<nuw><%for.body4>)[:4] OVERLAPS WITH ({(8 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.2>)[:4]
; CHECK-DAG:	IF ({((4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4>)[:4] OVERLAPS WITH ({(8 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.2>)[:4]
; CHECK-DAG:	IF ({(8 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.2>)[:4] OVERLAPS WITH ({(12 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.3>)[:4]
; CHECK-DAG:	IF ({(8 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.2>)[:4] OVERLAPS WITH ({(12 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.3>)[:4]
; CHECK-DAG:	IF ({@a,+,1280000}<nuw><%for.body4>)[:4] OVERLAPS WITH ({(4 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.1>)[:4]
; CHECK-DAG:	IF ({((4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4>)[:4] OVERLAPS WITH ({(4 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.1>)[:4]
; CHECK-DAG:	IF ({(4 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.1>)[:4] OVERLAPS WITH ({(8 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.2>)[:4]
; CHECK-DAG:	IF ({(4 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.1>)[:4] OVERLAPS WITH ({(8 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.2>)[:4]
; CHECK-DAG:	IF ({@a,+,1280000}<nuw><%for.body4>)[:4] OVERLAPS WITH ({(12 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.3>)[:4]
; CHECK-DAG:	IF ({((4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4>)[:4] OVERLAPS WITH ({(12 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.3>)[:4]
; CHECK-DAG:	IF ({(4 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.1>)[:4] OVERLAPS WITH ({(12 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.3>)[:4]
; CHECK-DAG:	IF ({(4 + (4 * (sext i32 %M to i64))<nsw> + @a),+,1280000}<nw><%for.body4.1>)[:4] OVERLAPS WITH ({(12 + @a)<nuw><nsw>,+,1280000}<nuw><%for.body4.3>)[:4]
