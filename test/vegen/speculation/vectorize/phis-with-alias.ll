...
; CHECK-NEXT:    [[S_1_1_CLONE_DEMOTED_0:%.*]] = select i1 [[CMP1_1_CLONE]], i32 [[I1_1_CLONE14]], i32 [[SPEC_SELECT]]
...
; CHECK-NEXT:    [[S_1_2_CLONE_DEMOTED_0:%.*]] = select i1 [[CMP1_2_CLONE]], i32 [[I1_2_CLONE16]], i32 [[S_1_1_CLONE_DEMOTED_0]]
...
; CHECK-NEXT:    [[S_1_3_CLONE_DEMOTED_0:%.*]] = select i1 [[CMP1_3_CLONE]], i32 [[I1_3_CLONE18]], i32 [[S_1_2_CLONE_DEMOTED_0]]
...
; CHECK:       10:
; CHECK-DAG:    [[TMP11:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 1
; CHECK-DAG:    [[TMP12:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 2
; CHECK-DAG:    [[TMP13:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 3
; CHECK-DAG:    [[TMP14:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 0
; CHECK-NEXT:    [[I1_CLONE12:%.*]] = load i32, ptr @d, align 16
; CHECK-NEXT:    [[SPEC_SELECT94:%.*]] = select i1 [[TMP14]], i32 [[I1_CLONE12]], i32 0
; CHECK-NEXT:    [[I1_1_CLONE:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 1), align 4
; CHECK-NEXT:    [[S_1_1_CLONE_DEMOTED3_0:%.*]] = select i1 [[TMP11]], i32 [[I1_1_CLONE]], i32 [[SPEC_SELECT94]]
...
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <4 x i32> undef, i32 [[SPEC_SELECT94]], i64 0
...
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <4 x i32> [[MUL_1_VEC]], i64 1
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <4 x i32> [[MUL_1_VEC]], i64 2
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <4 x i32> [[MUL_1_VEC]], i64 3
; CHECK-NEXT:    [[TMP22:%.*]] = extractelement <4 x i32> [[MUL_1_VEC]], i64 0
; CHECK-NEXT:    store i32 [[TMP22]], ptr [[B]], align 4, !tbaa [[TBAA5]], !alias.scope !9, !noalias !16
; CHECK-NEXT:    [[ARRAYIDX7_277:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 2
; CHECK-NEXT:    [[ARRAYIDX7_378:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 3
; CHECK-NEXT:    store i32 [[TMP19]], ptr [[ARRAYIDX7_1]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    store i32 [[TMP20]], ptr [[ARRAYIDX7_277]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    store i32 [[TMP21]], ptr [[ARRAYIDX7_378]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    br label [[TMP24]]
; CHECK:       23:
...
; CHECK-NEXT:    [[I2_1_VEC66:%.*]] = load <4 x i32>, ptr [[C]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_1_VEC67:%.*]] = mul <4 x i32> [[S_1_1_VEC]], [[I2_1_VEC66]]
; CHECK-NEXT:    store <4 x i32> [[MUL_1_VEC67]], ptr [[B]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    br label [[TMP24]]
; CHECK:       24:
; CHECK-NEXT:    ret void
;
