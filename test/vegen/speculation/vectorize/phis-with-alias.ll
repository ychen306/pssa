...
; RUN: %opt %s -S -passes=global-slp,sink,adce,instcombine,jump-threading,simplifycfg,adce,sink -do-versioning | FileCheck %s
...
; CHECK-NEXT:    [[UGLYGEP7:%.*]] = getelementptr i8, ptr [[B]], i64 4
; CHECK-NEXT:    [[IDENT_CHECK8:%.*]] = icmp ult ptr [[UGLYGEP7]], getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 1)
; CHECK-NEXT:    [[IDENT_CHECK9:%.*]] = icmp ugt ptr [[B]], getelementptr inbounds ([4 x i32], ptr @d, i64 1, i64 0)
; CHECK-NEXT:    [[TMP1:%.*]] = or i1 [[IDENT_CHECK8]], [[IDENT_CHECK9]]
; CHECK-NEXT:    [[IDENT_CHECK11:%.*]] = icmp ult ptr [[B]], [[C:%.*]]
; CHECK-NEXT:    [[UGLYGEP12:%.*]] = getelementptr i8, ptr [[C]], i64 16
; CHECK-NEXT:    [[IDENT_CHECK13:%.*]] = icmp ult ptr [[UGLYGEP12]], [[B]]
; CHECK-NEXT:    [[TMP2:%.*]] = or i1 [[IDENT_CHECK11]], [[IDENT_CHECK13]]
...
; CHECK:       12:
; CHECK-DAG:    [[TMP13:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 3
; CHECK-DAG:    [[TMP14:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 1
; CHECK-DAG:    [[TMP15:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 2
...
; CHECK-NEXT:    [[S_1_1_CLONE_DEMOTED4_0:%.*]] = select i1 [[TMP14]], i32 [[I1_1_CLONE]], i32 [[SPEC_SELECT102]]
; CHECK-NEXT:    [[I1_2_CLONE:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 2), align 8
; CHECK-NEXT:    [[S_1_2_CLONE_DEMOTED3_0:%.*]] = select i1 [[TMP15]], i32 [[I1_2_CLONE]], i32 [[S_1_1_CLONE_DEMOTED4_0]]
; CHECK-NEXT:    [[I1_3_CLONE:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 3), align 4
; CHECK-NEXT:    [[S_1_3_CLONE_DEMOTED2_0:%.*]] = select i1 [[TMP13]], i32 [[I1_3_CLONE]], i32 [[S_1_2_CLONE_DEMOTED3_0]]
