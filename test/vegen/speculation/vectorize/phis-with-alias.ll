...
; CHECK-NEXT:    [[S_1_2_CLONE_DEMOTED2_0:%.*]] = select i1 [[CMP1_2_CLONE]], i32 [[I1_2_CLONE]], i32 [[S_1_1_CLONE_DEMOTED3_0]]
; CHECK-NEXT:    [[I2_2_CLONE:%.*]] = load i32, ptr [[ARRAYIDX5_2]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_2_CLONE:%.*]] = mul nsw i32 [[S_1_2_CLONE_DEMOTED2_0]], [[I2_2_CLONE]]
...
; CHECK-NEXT:    [[S_1_3_CLONE_DEMOTED1_0:%.*]] = select i1 [[CMP1_3_CLONE]], i32 [[I1_3_CLONE]], i32 [[S_1_2_CLONE_DEMOTED2_0]]
; CHECK-NEXT:    [[I2_3_CLONE:%.*]] = load i32, ptr [[ARRAYIDX5_3]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_3_CLONE:%.*]] = mul nsw i32 [[S_1_3_CLONE_DEMOTED1_0]], [[I2_3_CLONE]]
...
; CHECK-NEXT:    br i1 [[DOTNOT]], label [[TMP15:%.*]], label [[TMP10:%.*]]
; CHECK:       10:
; CHECK:    [[TMP11:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 1
; CHECK:    [[TMP12:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 2
; CHECK:    [[TMP13:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 3
; CHECK:    [[TMP14:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 0
; CHECK-NEXT:    [[I1_CLONE12:%.*]] = load i32, ptr @d, align 16
; CHECK-NEXT:    [[SPEC_SELECT124:%.*]] = select i1 [[TMP14]], i32 [[I1_CLONE12]], i32 0
; CHECK-NEXT:    [[I2_CLONE14:%.*]] = load i32, ptr [[C]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_CLONE15:%.*]] = mul nsw i32 [[SPEC_SELECT124]], [[I2_CLONE14]]
; CHECK-NEXT:    store i32 [[MUL_CLONE15]], ptr [[B]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[ARRAYIDX5_2102:%.*]] = getelementptr inbounds i32, ptr [[C]], i64 2
; CHECK-NEXT:    [[ARRAYIDX5_3103:%.*]] = getelementptr inbounds i32, ptr [[C]], i64 3
; CHECK-NEXT:    [[ARRAYIDX7_2104:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 2
; CHECK-NEXT:    [[ARRAYIDX7_3105:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 3
; CHECK-NEXT:    [[I1_1_CLONE16:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 1), align 4
; CHECK-NEXT:    [[S_1_1_CLONE_DEMOTED_0:%.*]] = select i1 [[TMP11]], i32 [[I1_1_CLONE16]], i32 [[SPEC_SELECT124]]
; CHECK-NEXT:    [[I2_1_CLONE18:%.*]] = load i32, ptr [[ARRAYIDX5_1]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_1_CLONE19:%.*]] = mul nsw i32 [[S_1_1_CLONE_DEMOTED_0]], [[I2_1_CLONE18]]
; CHECK-NEXT:    store i32 [[MUL_1_CLONE19]], ptr [[ARRAYIDX7_1]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[I1_2_CLONE20:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 2), align 8
; CHECK-NEXT:    [[S_1_2_CLONE_DEMOTED_0:%.*]] = select i1 [[TMP12]], i32 [[I1_2_CLONE20]], i32 [[S_1_1_CLONE_DEMOTED_0]]
; CHECK-NEXT:    [[I2_2_CLONE22:%.*]] = load i32, ptr [[ARRAYIDX5_2102]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_2_CLONE23:%.*]] = mul nsw i32 [[S_1_2_CLONE_DEMOTED_0]], [[I2_2_CLONE22]]
; CHECK-NEXT:    store i32 [[MUL_2_CLONE23]], ptr [[ARRAYIDX7_2104]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[I1_3_CLONE24:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 3), align 4
; CHECK-NEXT:    [[S_1_3_CLONE_DEMOTED_0:%.*]] = select i1 [[TMP13]], i32 [[I1_3_CLONE24]], i32 [[S_1_2_CLONE_DEMOTED_0]]
; CHECK-NEXT:    [[I2_3_CLONE26:%.*]] = load i32, ptr [[ARRAYIDX5_3103]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_3_CLONE27:%.*]] = mul nsw i32 [[S_1_3_CLONE_DEMOTED_0]], [[I2_3_CLONE26]]
; CHECK-NEXT:    store i32 [[MUL_3_CLONE27]], ptr [[ARRAYIDX7_3105]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    br label [[TMP16]]
; CHECK:       15:
...
; CHECK-NEXT:    [[MUL_1_VEC:%.*]] = mul <4 x i32> [[S_1_1_VEC]], [[I2_1_VEC]]
