...
; CHECK-NEXT:    [[IDENT_CHECK:%.*]] = icmp ult ptr [[ARRAYIDX5_3]], getelementptr (i8, ptr @a, i64 4)
...
; CHECK-NEXT:    [[TMP5:%.*]] = extractelement <4 x float> [[I4_VEC]], i64 1
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <4 x float> [[I4_VEC]], i64 2
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <4 x float> [[I4_VEC]], i64 3
; CHECK-NEXT:    [[TMP8:%.*]] = fadd float [[TMP3]], [[TMP4]]
; CHECK-NEXT:    store float [[TMP8]], ptr [[ARRAYIDX5]], align 4, !tbaa [[TBAA5]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr getelementptr inbounds ([320000 x float], ptr @a, i64 0, i64 1), align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[TMP10:%.*]] = fadd float [[TMP9]], [[TMP5]]
; CHECK-NEXT:    store float [[TMP10]], ptr [[ARRAYIDX5_1]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr getelementptr inbounds ([320000 x float], ptr @a, i64 0, i64 2), align 8, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[TMP12:%.*]] = fadd float [[TMP11]], [[TMP6]]
; CHECK-NEXT:    store float [[TMP12]], ptr [[ARRAYIDX5_2]], align 4, !tbaa [[TBAA5]]
