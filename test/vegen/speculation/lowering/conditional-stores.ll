...
; RUN: %opt %s -S -passes=test-vector-codegen,simplifycfg,sink -find-conditional-deps -p storeOf:i1,storeOf:i3,storeOf:i5,storeOf:i7 -p cmp1,cmp1.1,cmp1.2,cmp1.3 -p i1,i3,i5,i7 -p i,i2,i4,i6 | FileCheck %s
