...
; RUN: %opt %s -S -passes=test-vector-codegen,sink,adce,instcombine,jump-threading,simplifycfg,adce,sink -find-conditional-deps -p s.1,s.1.1,s.1.2,s.1.3 -p i1,i1.1,i1.2,i1.3 -p cmp1,cmp1.1,cmp1.2,cmp1.3 -p mul,mul.1,mul.2,mul.3 -p storeOf:mul,storeOf:mul.1,storeOf:mul.2,storeOf:mul.3 -p i,i.1,i.2,i.3 -p i2,i2.1,i2.2,i2.3 | FileCheck %s
...
; CHECK-NEXT:    [[IDENT_CHECK:%.*]] = icmp ult ptr [[UGLYGEP]], getelementptr inbounds ([4 x i32], ptr @a, i64 0, i64 1)
; CHECK-NEXT:    [[IDENT_CHECK6:%.*]] = icmp ugt ptr [[B]], getelementptr inbounds ([4 x i32], ptr @a, i64 1, i64 0)
; CHECK-NEXT:    [[TMP0:%.*]] = or i1 [[IDENT_CHECK]], [[IDENT_CHECK6]]
; CHECK-NEXT:    [[IDENT_CHECK8:%.*]] = icmp ult ptr [[B]], [[C:%.*]]
; CHECK-NEXT:    [[UGLYGEP9:%.*]] = getelementptr i8, ptr [[C]], i64 16
; CHECK-NEXT:    [[IDENT_CHECK10:%.*]] = icmp ult ptr [[UGLYGEP9]], [[B]]
; CHECK-NEXT:    [[TMP1:%.*]] = or i1 [[IDENT_CHECK8]], [[IDENT_CHECK10]]
; CHECK-NEXT:    [[UGLYGEP11:%.*]] = getelementptr i8, ptr [[B]], i64 4
; CHECK-NEXT:    [[IDENT_CHECK12:%.*]] = icmp ult ptr [[UGLYGEP11]], getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 1)
; CHECK-NEXT:    [[IDENT_CHECK13:%.*]] = icmp ugt ptr [[B]], getelementptr inbounds ([4 x i32], ptr @d, i64 1, i64 0)
; CHECK-NEXT:    [[TMP2:%.*]] = or i1 [[IDENT_CHECK12]], [[IDENT_CHECK13]]
...
; CHECK-NEXT:    [[ARRAYIDX7_3:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 3
...
; CHECK-NEXT:    [[I1_1_CLONE19:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 1), align 4
; CHECK-NEXT:    [[S_1_1_CLONE_DEMOTED_0:%.*]] = select i1 [[CMP1_1_CLONE]], i32 [[I1_1_CLONE19]], i32 [[SPEC_SELECT]]
; CHECK-NEXT:    [[ARRAYIDX5_1:%.*]] = getelementptr inbounds i32, ptr [[C]], i64 1
; CHECK-NEXT:    [[I2_1_CLONE:%.*]] = load i32, ptr [[ARRAYIDX5_1]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_1_CLONE:%.*]] = mul nsw i32 [[S_1_1_CLONE_DEMOTED_0]], [[I2_1_CLONE]]
...
; CHECK-NEXT:    [[I1_2_CLONE21:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 2), align 8
; CHECK-NEXT:    [[S_1_2_CLONE_DEMOTED_0:%.*]] = select i1 [[CMP1_2_CLONE]], i32 [[I1_2_CLONE21]], i32 [[S_1_1_CLONE_DEMOTED_0]]
...
; CHECK-NEXT:    [[MUL_2_CLONE:%.*]] = mul nsw i32 [[S_1_2_CLONE_DEMOTED_0]], [[I2_2_CLONE]]
...
; CHECK-NEXT:    [[I1_3_CLONE23:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 3), align 4
; CHECK-NEXT:    [[S_1_3_CLONE_DEMOTED_0:%.*]] = select i1 [[CMP1_3_CLONE]], i32 [[I1_3_CLONE23]], i32 [[S_1_2_CLONE_DEMOTED_0]]
...
; CHECK:       6:
; CHECK-NEXT:    [[I_1_VEC:%.*]] = load <4 x i32>, ptr @a, align 16, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[CMP1_1_VEC:%.*]] = icmp sgt <4 x i32> [[I_1_VEC]], zeroinitializer
; CHECK-NEXT:    [[UGLYGEP14:%.*]] = getelementptr i8, ptr [[B]], i64 4
; CHECK-NEXT:    [[IDENT_CHECK15:%.*]] = icmp ult ptr [[UGLYGEP14]], getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 1)
; CHECK-NEXT:    [[IDENT_CHECK16:%.*]] = icmp ugt ptr [[B]], getelementptr inbounds ([4 x i32], ptr @d, i64 1, i64 0)
; CHECK-NEXT:    [[TMP7:%.*]] = or i1 [[IDENT_CHECK15]], [[IDENT_CHECK16]]
; CHECK-NEXT:    [[TMP8:%.*]] = xor <4 x i1> [[CMP1_1_VEC]], <i1 poison, i1 true, i1 true, i1 true>
; CHECK-NEXT:    [[TMP9:%.*]] = shufflevector <4 x i1> [[TMP8]], <4 x i1> undef
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast <3 x i1> [[TMP9]] to i3
; CHECK-NEXT:    [[DOTNOT:%.*]] = icmp eq i3 [[TMP10]], 0
; CHECK-NEXT:    [[TMP11:%.*]] = and i1 [[TMP7]], [[DOTNOT]]
; CHECK-NEXT:    br i1 [[TMP11]], label [[TMP25:%.*]], label [[TMP12:%.*]]
; CHECK:       12:
; CHECK-DAG:    [[TMP13:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 1
; CHECK-DAG:    [[TMP14:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 2
; CHECK-DAG:    [[TMP15:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 3
; CHECK-DAG:    [[TMP16:%.*]] = extractelement <4 x i1> [[CMP1_1_VEC]], i64 0
; CHECK-NEXT:    [[I1_CLONE17:%.*]] = load i32, ptr @d, align 16
; CHECK-NEXT:    [[SPEC_SELECT102:%.*]] = select i1 [[TMP16]], i32 [[I1_CLONE17]], i32 0
; CHECK-NEXT:    [[I1_1_CLONE:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 1), align 4
; CHECK-NEXT:    [[S_1_1_CLONE_DEMOTED4_0:%.*]] = select i1 [[TMP13]], i32 [[I1_1_CLONE]], i32 [[SPEC_SELECT102]]
; CHECK-NEXT:    [[I1_2_CLONE:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 2), align 8
; CHECK-NEXT:    [[S_1_2_CLONE_DEMOTED3_0:%.*]] = select i1 [[TMP14]], i32 [[I1_2_CLONE]], i32 [[S_1_1_CLONE_DEMOTED4_0]]
; CHECK-NEXT:    [[I1_3_CLONE:%.*]] = load i32, ptr getelementptr inbounds ([4 x i32], ptr @d, i64 0, i64 3), align 4
; CHECK-NEXT:    [[S_1_3_CLONE_DEMOTED2_0:%.*]] = select i1 [[TMP15]], i32 [[I1_3_CLONE]], i32 [[S_1_2_CLONE_DEMOTED3_0]]
; CHECK-NEXT:    [[TMP17:%.*]] = insertelement <4 x i32> undef, i32 [[SPEC_SELECT102]], i64 0
; CHECK-NEXT:    [[TMP18:%.*]] = insertelement <4 x i32> [[TMP17]], i32 [[S_1_1_CLONE_DEMOTED4_0]], i64 1
; CHECK-NEXT:    [[TMP19:%.*]] = insertelement <4 x i32> [[TMP18]], i32 [[S_1_2_CLONE_DEMOTED3_0]], i64 2
; CHECK-NEXT:    [[TMP20:%.*]] = insertelement <4 x i32> [[TMP19]], i32 [[S_1_3_CLONE_DEMOTED2_0]], i64 3
; CHECK-NEXT:    [[I2_1_VEC:%.*]] = load <4 x i32>, ptr [[C]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_1_VEC:%.*]] = mul <4 x i32> [[TMP20]], [[I2_1_VEC]]
...
; CHECK-NEXT:    [[TMP24:%.*]] = extractelement <4 x i32> [[MUL_1_VEC]], i64 0
; CHECK-NEXT:    store i32 [[TMP24]], ptr [[B]], align 4, !tbaa [[TBAA5]], !alias.scope !9, !noalias !16
; CHECK-NEXT:    [[ARRAYIDX7_182:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 1
; CHECK-NEXT:    [[ARRAYIDX7_283:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 2
; CHECK-NEXT:    [[ARRAYIDX7_384:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 3
; CHECK-NEXT:    store i32 [[TMP21]], ptr [[ARRAYIDX7_182]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    store i32 [[TMP22]], ptr [[ARRAYIDX7_283]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    store i32 [[TMP23]], ptr [[ARRAYIDX7_384]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    br label [[TMP26]]
; CHECK:       25:
; CHECK-NEXT:    [[I1_1_VEC:%.*]] = load <4 x i32>, ptr @d, align 16, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[S_1_1_VEC:%.*]] = select <4 x i1> [[CMP1_1_VEC]], <4 x i32> [[I1_1_VEC]], <4 x i32> <i32 0, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[I2_1_VEC71:%.*]] = load <4 x i32>, ptr [[C]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[MUL_1_VEC72:%.*]] = mul <4 x i32> [[S_1_1_VEC]], [[I2_1_VEC71]]
; CHECK-NEXT:    store <4 x i32> [[MUL_1_VEC72]], ptr [[B]], align 4, !tbaa [[TBAA5]]
; CHECK-NEXT:    br label [[TMP26]]
; CHECK:       26:
; CHECK-NEXT:    ret void
;
