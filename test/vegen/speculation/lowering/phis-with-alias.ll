...
; CHECK-LABEL: @foo(
; CHECK-NEXT:  entry:
; CHECK:    [[ARRAYIDX7_1:%.*]] = getelementptr inbounds i32, ptr [[B:%.*]], i64 1
...
; CHECK-NEXT:    store i32 [[TMP22]], ptr [[B]], align 4, !tbaa [[TBAA5]]
...
; CHECK-NEXT:    [[I2_1_VEC66:%.*]] = load <4 x i32>, ptr [[C]], align 4
; CHECK-NEXT:    [[MUL_1_VEC67:%.*]] = mul <4 x i32> [[S_1_1_VEC]], [[I2_1_VEC66]]
; CHECK-NEXT:    store <4 x i32> [[MUL_1_VEC67]], ptr [[B]], align 4
; CHECK-NEXT:    br label [[TMP24]]
; CHECK:       24:
; CHECK-NEXT:    ret void
;
